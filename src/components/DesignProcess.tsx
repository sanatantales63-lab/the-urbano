...
export default function DesignProcess() {
  ...
  return (
    <>
      {/* ── DESKTOP: Sticky horizontal scroll — no GSAP pin, pure CSS sticky ── */}
      <div
        ref={sectionRef}
      ...
      >
        <section
          className="sticky top-0 h-screen bg-[#fafafa] flex items-center overflow-hidden border-t border-gray-100"
        ...
        >
          ...
          <div className="absolute bottom-10 left-24 right-24 h-[2px] bg-[#C4956A]/10">
            <div 
              className="h-full bg-gradient-to-r from-[#203a27] to-[#C4956A] origin-left transition-transform duration-100" 
